...
public:
  ...
  size_t size() {
    return shared->dim_A + shared->dim_E + shared->dim_F + shared->dim_N + shared->dim_P + shared->dim_R + shared->dim_S + shared->dim_U + shared->dim_prev_A + shared->dim_prev_R + 28;
  }
  std::vector<real_type> initial(size_t step) {
    std::vector<real_type> state(shared->dim_A + shared->dim_E + shared->dim_F + shared->dim_N + shared->dim_P + shared->dim_R + shared->dim_S + shared->dim_U + shared->dim_prev_A + shared->dim_prev_R + 28);
    ...
    state[10] = shared->initial_daily_gas_pharyngitis_rate_04;
    state[11] = shared->initial_daily_gas_pharyngitis_rate_05_14;
    state[12] = shared->initial_daily_gas_pharyngitis_rate_15_44;
    state[13] = shared->initial_daily_gas_pharyngitis_rate_45_64;
    state[14] = shared->initial_daily_gas_pharyngitis_rate_65_74;
    state[15] = shared->initial_daily_gas_pharyngitis_rate_75;
    state[16] = shared->initial_daily_scarlet_fever_rate_04;
    ...
    state[22] = shared->initial_scarlet_fever_inc_04;
    state[23] = shared->initial_scarlet_fever_inc_05_14;
    state[24] = shared->initial_scarlet_fever_inc_15_44;
    state[25] = shared->initial_scarlet_fever_inc_45_64;
    state[26] = shared->initial_scarlet_fever_inc_65_74;
    state[27] = shared->initial_scarlet_fever_inc_75;
    std::copy(shared->initial_U.begin(), shared->initial_U.end(), state.begin() + 28);
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    state_next[16] = ((shared->n_group == 16 ? internal.scarlet_fever_inc_by_group[0] / (real_type) internal.w[0] : 0));
    state_next[17] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 1, 3) / (real_type) odin_sum1<real_type>(internal.w.data(), 1, 3) : 0));
    state_next[18] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 3, 9) / (real_type) odin_sum1<real_type>(internal.w.data(), 3, 9) : 0));
    state_next[19] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 9, 13) / (real_type) odin_sum1<real_type>(internal.w.data(), 9, 13) : 0));
    state_next[20] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 13, 15) / (real_type) odin_sum1<real_type>(internal.w.data(), 13, 15) : 0));
    state_next[21] = ((shared->n_group == 16 ? internal.scarlet_fever_inc_by_group[15] / (real_type) internal.w[15] : 0));
    ...
    state_next[22] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 0, 1) : 0));
    state_next[23] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 1, 3) : 0));
    state_next[24] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 3, 9) : 0));
    state_next[25] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 9, 13) : 0));
    state_next[26] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.scarlet_fever_inc_by_group.data(), 13, 15) : 0));
    state_next[27] = ((shared->n_group == 16 ? internal.scarlet_fever_inc_by_group[15] : 0));
    ...
    for (int i = 1; i <= shared->dim_U; ++i) {
      state_next[28 + i - 1] = U[i - 1] + internal.dem_U[i - 1] + internal.gas_U[i - 1];
    }
    ...
    state_next[10] = ((shared->n_group == 16 ? internal.gas_pharyngitis_inc_by_group[0] / (real_type) internal.w[0] : 0));
    state_next[11] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.gas_pharyngitis_inc_by_group.data(), 1, 3) / (real_type) odin_sum1<real_type>(internal.w.data(), 1, 3) : 0));
    state_next[12] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.gas_pharyngitis_inc_by_group.data(), 3, 9) / (real_type) odin_sum1<real_type>(internal.w.data(), 3, 9) : 0));
    state_next[13] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.gas_pharyngitis_inc_by_group.data(), 9, 13) / (real_type) odin_sum1<real_type>(internal.w.data(), 9, 13) : 0));
    state_next[14] = ((shared->n_group == 16 ? odin_sum1<real_type>(internal.gas_pharyngitis_inc_by_group.data(), 13, 15) / (real_type) odin_sum1<real_type>(internal.w.data(), 13, 15) : 0));
    state_next[15] = ((shared->n_group == 16 ? internal.gas_pharyngitis_inc_by_group[15] / (real_type) internal.w[15] : 0));
...
dust::pars_type<model> dust_pars<model>(cpp11::list user) {
  ...
  shared->offset_variable_A = shared->dim_N + shared->dim_U + shared->dim_prev_A + shared->dim_prev_R + 28;
  shared->offset_variable_N = shared->dim_U + 28;
  shared->offset_variable_prev_A = shared->dim_N + shared->dim_U + 28;
  shared->offset_variable_prev_R = shared->dim_N + shared->dim_U + shared->dim_prev_A + 28;
  ...
  shared->offset_variable_E = shared->dim_A + shared->dim_N + shared->dim_U + shared->dim_prev_A + shared->dim_prev_R + 28;
  shared->offset_variable_F = shared->dim_A + shared->dim_E + shared->dim_N + shared->dim_P + shared->dim_S + shared->dim_U + shared->dim_prev_A + shared->dim_prev_R + 28;
  shared->offset_variable_P = shared->dim_A + shared->dim_E + shared->dim_N + shared->dim_S + shared->dim_U + shared->dim_prev_A + shared->dim_prev_R + 28;
  shared->offset_variable_R = shared->dim_A + shared->dim_E + shared->dim_F + shared->dim_N + shared->dim_P + shared->dim_S + shared->dim_U + shared->dim_prev_A + shared->dim_prev_R + 28;
  shared->offset_variable_S = shared->dim_A + shared->dim_E + shared->dim_N + shared->dim_U + shared->dim_prev_A + shared->dim_prev_R + 28;
...
cpp11::sexp dust_info<model>(const dust::pars_type<model>& pars) {
  ...
  dim[28] = cpp11::writable::integers({shared->dim_U});
  dim[29] = cpp11::writable::integers({shared->dim_N});
  dim[30] = cpp11::writable::integers({shared->dim_prev_A});
  dim[31] = cpp11::writable::integers({shared->dim_prev_R});
  dim[32] = cpp11::writable::integers({shared->dim_A_1, shared->dim_A_2});
  dim[33] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2});
  dim[34] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[35] = cpp11::writable::integers({shared->dim_P_1, shared->dim_P_2});
  dim[36] = cpp11::writable::integers({shared->dim_F_1, shared->dim_F_2});
  dim[37] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2});
  dim.names() = nms;
  ...
  index[28] = integer_sequence(29, shared->dim_U);
  index[29] = integer_sequence(shared->offset_variable_N + 1, shared->dim_N);
  index[30] = integer_sequence(shared->offset_variable_prev_A + 1, shared->dim_prev_A);
  index[31] = integer_sequence(shared->offset_variable_prev_R + 1, shared->dim_prev_R);
  index[32] = integer_sequence(shared->offset_variable_A + 1, shared->dim_A);
  ...
  index[35] = integer_sequence(shared->offset_variable_P + 1, shared->dim_P);
  index[36] = integer_sequence(shared->offset_variable_F + 1, shared->dim_F);
  index[37] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index.names() = nms;
